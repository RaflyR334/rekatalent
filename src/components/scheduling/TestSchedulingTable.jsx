...
const TestSchedulingTable = () => {
    ...
    const handleAddTest = () => {
        navigate("/test-schedulings/create");
    };

    // Navigate to Edit Test form
    const handleEditTest = (test) => {
        navigate(`/test-schedulings/edit/${test.id}`);
    };
    ...
    return (
        ...
        >
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-gray-100">List Psycho Test Scheduling</h2>
